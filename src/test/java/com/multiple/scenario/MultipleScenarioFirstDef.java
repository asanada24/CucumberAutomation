...
public class MultipleScenarioFirstDef {
    WebDriver driver;
    ...
    public void user_enter_the_user_first_name() throws InterruptedException {
    ...
    public void user_enters_the_password() throws InterruptedException {
        driver.findElement(By.xpath("//input[@id='pass']")).sendKeys("chitti@123");
        Thread.sleep(1000);
    }
